...
PageBreak			: "Inserta un salt de pàgina",
...
NoActiveX			: "La configuració de seguretat del teu navegador podria limitar algunes de les funcionalitats de l'editor. Has d'activar l'opció de controls i connexions ActiveX (\"Run ActiveX controls and plug-ins\"). És possible que et trobis amb errors o que trobis a faltar funcionaitats..",
BrowseServerBlocked : "El navegador de continguts no ha pogut obrir-se. Verifica que tinguis deshavilitats les eines que eviten popups (les finestres emergents).",
DialogBlocked		: "No ha estat possible d'obrir la finestra de diàleg emergent. Assegura't que no estiguis bloquejant els popups.",
