<%@ page language="VB" masterpagefile="~/Template.master" autoeventwireup="false" inherits="MB.TheBeerHouse.UI.BrowseThreads, MB.TheBeerHouse" title="The Beer House - Browse Threads: {0}" theme="TemplateMonster" maintainScrollPositionOnPostBack="true" %>
