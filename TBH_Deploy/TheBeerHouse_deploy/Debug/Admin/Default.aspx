<%@ page language="VB" masterpagefile="~/Template.master" autoeventwireup="false" inherits="MB.TheBeerHouse.UI.Admin._Default, MB.TheBeerHouse" title="The Beer House - Administration" theme="TemplateMonster" maintainScrollPositionOnPostBack="true" %>
