<%@ Page Language="VB" MasterPageFile="~/Template.master" AutoEventWireup="false" CodeFile="ShowDepartments.aspx.vb" Inherits="MB.TheBeerHouse.UI.ShowDepartments" title="The Beer House - Show Departments" %>
