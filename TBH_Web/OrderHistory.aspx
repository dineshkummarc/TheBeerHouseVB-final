<%@ Page Language="VB" MasterPageFile="~/Template.master" AutoEventWireup="false" CodeFile="OrderHistory.aspx.vb" Inherits="MB.TheBeerHouse.UI.OrderHistory" title="The Beer House - Order History" %>
