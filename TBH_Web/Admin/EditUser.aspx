<%@ Page Language="VB" MasterPageFile="~/Template.master" AutoEventWireup="false" CodeFile="EditUser.aspx.vb" Inherits="MB.TheBeerHouse.UI.Admin.EditUser" title="The Beer House - Edit User" %>
