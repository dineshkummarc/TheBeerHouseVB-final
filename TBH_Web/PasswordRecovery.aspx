<%@ Page Language="VB" MasterPageFile="~/Template.master" AutoEventWireup="false" CodeFile="PasswordRecovery.aspx.vb" Inherits="MB.TheBeerHouse.UI.PasswordRecovery" title="The Beer House - Password Recovery" %>
