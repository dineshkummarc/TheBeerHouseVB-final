<%@ Page Language="VB" MasterPageFile="~/Template.master" AutoEventWireup="false" CodeFile="Error.aspx.vb" Inherits="MB.TheBeerHouse.UI.Error" title="The Beer House - Error" %>
